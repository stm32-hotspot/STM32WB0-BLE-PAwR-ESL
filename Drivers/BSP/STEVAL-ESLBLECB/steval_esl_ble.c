...
/** @defgroup STEVAL_ESL_BLE STEVAL_ESL_BLE
  * @{
  */

/** @defgroup STEVAL_ESL_BLE_COMMON STEVAL_ESL_BLE COMMON
  * @brief This file provides set of firmware functions to manage Leds and push-button
  *        available on NUCLEO-WB09KE Kit from STMicroelectronics.
  * @{
  */

/** @defgroup STEVAL_ESL_BLE_COMMON_Private_Defines STEVAL_ESL_BLE COMMON Private Defines
  * @{
  */
...
/** @defgroup STEVAL_ESL_BLE_COMMON_Private_TypesDefinitions STEVAL_ESL_BLE COMMON Private Types Definitions
  * @{
  */
/**
  * @}
...
/** @defgroup STEVAL_ESL_BLE_COMMON_Private_FunctionPrototypes STEVAL_ESL_BLE COMMON Private Function Prototypes
  * @{
  */
...
/** @defgroup STEVAL_ESL_BLE_COMMON_Exported_Variables STEVAL_ESL_BLE COMMON Exported Variables
  * @{
  */
#if (USE_BSP_COM_FEATURE == 1)
...
/** @defgroup STEVAL_ESL_BLE_COMMON_Private_Variables STEVAL_ESL_BLE COMMON Private Variables
  * @{
  */
...
/** @defgroup STEVAL_ESL_BLE_COMMON_Exported_Functions STEVAL_ESL_BLE COMMON Exported Functions
  * @{
  */
...
{
  return ((int32_t)STEVAL_ESL_BLE_BSP_VERSION);
}
...
{
  return (const uint8_t*)STEVAL_ESL_BLE_BSP_BOARD_NAME;
}
...
{
  return (const uint8_t*)STEVAL_ESL_BLE_BSP_BOARD_ID;
}
...
/** @defgroup STEVAL_ESL_BLE_COMMON_LED_Functions STEVAL_ESL_BLE COMMON LED Functions
  * @{
  */
...
int32_t BSP_LED_Init(Led_TypeDef Led)
{
  ...
  BSP_PWRGIOPullConfigure(LED_PORT[Led], LED_PIN[Led], GPIO_PULLUP);
...
/** @defgroup STEVAL_ESL_BLE_COMMON_BUTTON_Functions STEVAL_ESL_BLE_COMMON BUTTON Functions
  * @{
  */
...
int32_t BSP_PB_Init(Button_TypeDef Button, ButtonMode_TypeDef ButtonMode)
{
  ...
  BSP_PWRGIOPullConfigure(BUTTON_PORT[Button], BUTTON_PIN[Button], GPIO_NOPULL);
...
#if (USE_BSP_COM_FEATURE == 1)
/** @defgroup STEVAL_ESL_BLE_COMMON_COM_Functions STEVAL_ESL_BLE COMMON COM Functions
  * @{
  */
...
/** @defgroup STEVAL_ESL_BLE_COMMON_Private_Functions STEVAL_ESL_BLE COMMON Private Functions
  * @{
  */
