/**
  ******************************************************************************
  * @file    stm32wb0x_esl1kcb.c
  * @author  GPM WBL Application Team
  * @brief   This file provides set of firmware functions to manage:
  *          - LEDs and push-button available on STEVAL-ESL1KCB Kit
...
/** @defgroup STM32WB0X_ESL1KCB STM32WB0X_ESL1KCB
  * @{
  */

/** @defgroup STM32WB0X_ESL1KCB_COMMON STM32WB0X_ESL1KCB COMMON
  * @brief This file provides set of firmware functions to manage Leds and push-button
  *        available on NUCLEO-WB09KE Kit from STMicroelectronics.
  * @{
  */

/** @defgroup STM32WB0X_ESL1KCB_COMMON_Private_Defines STM32WB0X_ESL1KCB COMMON Private Defines
  * @{
  */
...
/** @defgroup STM32WB0X_ESL1KCB_COMMON_Private_TypesDefinitions STM32WB0X_ESL1KCB COMMON Private Types Definitions
  * @{
  */
/**
  * @}
...
/** @defgroup STM32WB0X_ESL1KCB_COMMON_Private_FunctionPrototypes STM32WB0X_ESL1KCB COMMON Private Function Prototypes
  * @{
  */
...
/** @defgroup STM32WB0X_ESL1KCB_COMMON_Exported_Variables STM32WB0X_ESL1KCB COMMON Exported Variables
  * @{
  */
#if (USE_BSP_COM_FEATURE == 1)
...
/** @defgroup STM32WB0X_ESL1KCB_COMMON_Private_Variables STM32WB0X_ESL1KCB COMMON Private Variables
  * @{
  */
...
/** @defgroup STM32WB0X_ESL1KCB_COMMON_Exported_Functions STM32WB0X_ESL1KCB COMMON Exported Functions
  * @{
  */

/**
  * @brief  This method returns the NUCLEO-WB09KE BSP Driver revision.
  * @retval version : 0xXYZR (8bits for each decimal, R for RC).
  */
int32_t BSP_GetVersion(void)
{
  return ((int32_t)STM32WB0X_ESL1KCB_BSP_VERSION);
}
...
{
  return (const uint8_t*)STM32WB0X_ESL1KCB_BSP_BOARD_NAME;
}
...
{
  return (const uint8_t*)STM32WB0X_ESL1KCB_BSP_BOARD_ID;
}

/** @defgroup STM32WB0X_ESL1KCB_COMMON_LED_Functions STM32WB0X_ESL1KCB COMMON LED Functions
  * @{
  */
...
int32_t BSP_LED_Init(Led_TypeDef Led)
{
  ...
  if( LL_PWR_IsEnabledPUPDCfg() != 0)
  {
    ...
    {
      LL_PWR_DisableGPIOPullUp( LL_PWR_GPIO_A, GPIO_Init.Pin);
    }
     if (LED_PORT[Led] == GPIOB)
    {
      LL_PWR_DisableGPIOPullUp( LL_PWR_GPIO_B, GPIO_Init.Pin);
    }
  }
...
/** @defgroup STM32WB0X_ESL1KCB_COMMON_BUTTON_Functions STM32WB0X_ESL1KCB_COMMON BUTTON Functions
  * @{
  */
...
int32_t BSP_PB_GetState(Button_TypeDef Button)
{
  ...
  status = (HAL_GPIO_ReadPin(BUTTON_PORT[Button], BUTTON_PIN[Button]) == GPIO_PIN_RESET) ? 0 : 1;
...
#if (USE_BSP_COM_FEATURE == 1)
/** @defgroup STM32WB0X_ESL1KCB_COMMON_COM_Functions STM32WB0X_ESL1KCB COMMON COM Functions
  * @{
  */
...
/** @defgroup STM32WB0X_ESL1KCB_COMMON_Private_Functions STM32WB0X_ESL1KCB COMMON Private Functions
  * @{
  */
