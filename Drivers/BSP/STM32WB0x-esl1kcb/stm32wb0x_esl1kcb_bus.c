...
/* Includes ------------------------------------------------------------------*/
#include "stm32wb0x_esl1kcb_bus.h"
...
/** @defgroup STM32WB0X_ESL1KCB_BUS_Exported_Variables BUS Exported Variables
  * @{
  */
...
/** @defgroup STM32WB0X_ESL1KCB_BUS_Private_Variables BUS Private Variables
  * @{
  */
...
/** @defgroup STM32WB0X_ESL1KCB_BUS_Private_FunctionPrototypes  BUS Private Function
  * @{
  */
...
/** @defgroup STM32WB0X_ESL1KCB_LOW_LEVEL_Private_Functions STM32WB0X_ESL1KCB LOW LEVEL Private Functions
  * @{
  */

/** @defgroup STM32WB0X_ESL1KCB_BUS_Exported_Functions STM32WB0X_ESL1KCB_BUS Exported Functions
  * @{
  */
...
void I2C1_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  LL_PWR_EnableGPIOPullUp(I2Cx_SCL_PWR_PORT, I2Cx_SCL_PIN);
  LL_PWR_EnableGPIOPullUp(I2Cx_SDA_PWR_PORT, I2Cx_SDA_PIN);
