...
ErrorStatus LL_TIM_DeInit(const TIM_TypeDef *TIMx)
{
  ...
  if (TIMx == TIM1)
  {
    LL_APB0_GRP1_ForceReset(LL_APB0_GRP1_PERIPH_TIM1);
    LL_APB0_GRP1_ReleaseReset(LL_APB0_GRP1_PERIPH_TIM1);
  }
#else
  if (TIMx == TIM2)
  {
  ...
  {
    LL_APB0_GRP1_ForceReset(LL_APB0_GRP1_PERIPH_TIM17);
    LL_APB0_GRP1_ReleaseReset(LL_APB0_GRP1_PERIPH_TIM17);
  }
#endif /* TIM1 */
  else
  {
