/**
  ******************************************************************************
  * @file    stm32wb0x_hal_smartcard.h
...
#ifndef STM32WB0x_HAL_SMARTCARD_H
...
/** @brief  Check the Baud rate range.
  * @note   The maximum Baud Rate is derived from the maximum clock on WB0 (16 MHz)
...
#include "stm32wb0x_hal_smartcard_ex.h"
...
#endif /* STM32WB0x_HAL_SMARTCARD_H */
