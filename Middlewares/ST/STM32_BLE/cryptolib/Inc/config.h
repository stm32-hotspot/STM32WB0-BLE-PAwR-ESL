...
typedef struct
{
  ...
  uint8_t DrbgConf ;           /*!< Used to get if the deterministic random bit generator is included.
...
#define VERSION_Y 2 /*!< The Y parameter of the current STM32 crypto library version */
...
/**
  ...
  * @{
  */
#define SW      ((uint8_t)0x01)         /*!< This implementation is Full SW */
/* #define HW                 ((uint8_t)0x02)   */    /*!< This implementation support a HW accelerations*/
...
//#define RSA_WINDOW_SIZE 4   /*!< Window size selected is 4 */
  ...
  /**
    ...
    *  the key and so needs to be generated at runtime (through AES_GCM_keyschedule), the other
