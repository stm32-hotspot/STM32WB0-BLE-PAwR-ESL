...
/**
  * @brief   This macro outputs the 4 octets that form the input 32bit integer
...
/**
  * @brief   This macro returns an integer from 4 octets
...
/**
  ...
  *                        4 byte array into a 32 bit integer or vice-versa.
