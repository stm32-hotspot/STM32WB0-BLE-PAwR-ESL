...
/* USER CODE BEGIN MX_GPIO_Init_2 */
  ...
  BSP_PWRGIOPullConfigure(GPIOB, RST_Pin|DC_Pin, GPIO_NOPULL);
  ...
  BSP_PWRGIOPullConfigure(GPIOA, SPI_CS_Pin, GPIO_NOPULL);
  ...
  BSP_PWRGIOPullConfigure(BUSY_GPIO_Port, BUSY_Pin, GPIO_NOPULL);  
  ...
  BSP_PWRGIOPullConfigure(GPIOB, GPIO_PIN_15, GPIO_NOPULL);
  ...
  BSP_PWRGIOPullConfigure(GPIOA, GPIO_PIN_8|GPIO_PIN_10, GPIO_NOPULL);
