...
/* USER CODE BEGIN PD */
#if (CFG_BUTTON_SUPPORTED == 1)
#define BUTTON_LONG_PRESS_THRESHOLD_MS   (1500u)
...
uint32_t MX_APPE_Init(void *p_param)
{
  ...
  if(RAM_VR.ResetReason & (RCC_FLAG_WDGRST|RCC_CSR_SFTRSTF))
  {
    ESL_DISPLAY_Init(0);        
  }
  else
