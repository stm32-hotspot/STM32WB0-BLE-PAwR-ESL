/**
  ...
  * @author  MMY-SRA Team
  * @brief   This file provides set of driver functions to interface ST25DV 
  ******************************************************************************
  * @attention
  *
...
int32_t NFCTAG_Init (uint32_t Instance)
{
  ...
  IO.Init         = NFC_I2C_Init;
  IO.DeInit       = NFC_I2C_DeInit;
  IO.IsReady      = NFC_I2C_IsReady;
  IO.Read         = NFC_I2C_ReadReg16;
  IO.Write        = (ST25DV_Write_Func)NFC_I2C_WriteReg16;
