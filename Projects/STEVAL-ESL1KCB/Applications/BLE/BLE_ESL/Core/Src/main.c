...
static void MX_GPIO_Init(void)
{
  ...
  HAL_PWREx_DisableGPIOPullUp(RST_PWR_GPIO_Port, RST_PWR_GPIO_Pin);
  HAL_PWREx_DisableGPIOPullDown(RST_PWR_GPIO_Port, RST_PWR_GPIO_Pin);
  ...
  HAL_PWREx_DisableGPIOPullUp(SPI_CS_PWR_GPIO_Port, SPI_CS_PWR_GPIO_Pin);
  HAL_PWREx_DisableGPIOPullDown(SPI_CS_PWR_GPIO_Port, SPI_CS_PWR_GPIO_Pin);
  ...
  HAL_PWREx_DisableGPIOPullUp(BUSY_PWR_GPIO_Port, BUSY_PWR_GPIO_Pin);
  HAL_PWREx_DisableGPIOPullDown(BUSY_PWR_GPIO_Port, BUSY_PWR_GPIO_Pin);
...
static void MX_SPI_MASTER_Init(void)
{
  ...
  hspiMaster.Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_16;
  ...
  hspiMaster.Init.CRCPolynomial = 10;
  ...
  /* USER CODE BEGIN SPI_MASTER_Init 2 */
