...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==SPI_MASTER)
  {
    ...
    HAL_PWREx_DisableGPIOPullUp(SPI_SCK_PWR_GPIO_Port, SPI_SCK_PWR_GPIO_Pin);
    HAL_PWREx_DisableGPIOPullDown(SPI_SCK_PWR_GPIO_Port, SPI_SCK_PWR_GPIO_Pin);
    ...
    HAL_PWREx_DisableGPIOPullUp(SPI_MOSI_PWR_GPIO_Port, SPI_MOSI_PWR_GPIO_Pin);
    HAL_PWREx_DisableGPIOPullDown(SPI_MOSI_PWR_GPIO_Port, SPI_MOSI_PWR_GPIO_Pin);
  }
